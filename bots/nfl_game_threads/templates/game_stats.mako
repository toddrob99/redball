<%
    ...
    pass_alignmentRow += ":--|"
    pass_visitorRow += f'{v["passingCompletions"]}/{v["passingAttempts"]}|'
    ...
    pass_alignmentRow += ":--|"
    pass_visitorRow += f'{v["passingFirstDowns"]}|'
    pass_homeRow += f'{h["passingFirstDowns"]}|'

    # Pass TD
    pass_headerRow += "TD|"
    pass_alignmentRow += ":--|"
    pass_visitorRow += f'{v["passingTouchdowns"]}|'
    pass_homeRow += f'{h["passingTouchdowns"]}|'

    # Sacked
    pass_headerRow += "Sacked (Yds)|"
    pass_alignmentRow += ":--|"
    pass_visitorRow += f'{v["passingSacked"] if v["passingSacked"] else 0} ({v["passingSackedYardsLost"] if v["passingSackedYardsLost"] else "-"})|'
    pass_homeRow += f'{h["passingSacked"] if h["passingSacked"] else 0} ({h["passingSackedYardsLost"] if h["passingSackedYardsLost"] else "-"})|'

    # Interceptions
    pass_headerRow += "Int|"
    pass_alignmentRow += ":--|"
    pass_visitorRow += f'{v["passingInterceptions"]}|'
    ...
    rush_headerRow += "Att|"
    rush_alignmentRow += ":--|"
    rush_visitorRow += f'{v["rushingAttempts"]}|'
    ...
    rush_alignmentRow += ":--|"
    rush_visitorRow += f'{v["rushingFirstDowns"]}|'
    rush_homeRow += f'{h["rushingFirstDowns"]}|'

    # Rushing TD
    rush_headerRow += "TD|"
    rush_alignmentRow += ":--|"
    rush_visitorRow += f'{v["rushingTouchdowns"]}|'
    rush_homeRow += f'{h["rushingTouchdowns"]}|'

    # Rushing Fumbles
    rush_headerRow += "Fumbles|"
    rush_alignmentRow += ":--|"
    rush_visitorRow += f'{v["rushingFumbles"] if v["rushingFumbles"] else 0}|'
