...
|:--|:--|:--|:--|:--|:--|:--|:--|
## Team
|[${awayTeam["teamName"]}](${data["teamSubs"].get(awayTeam["abbreviation"], "")})|${awayStats["shots"]}|${round(float(awayStats["faceOffWinPercentage"]))}%|\
...
|[${homeTeam["teamName"]}](${data["teamSubs"].get(homeTeam["abbreviation"], "")})|${homeStats["shots"]}|${round(float(homeStats["faceOffWinPercentage"]))}%|\
