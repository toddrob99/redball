...
## Date/Time
${(" - " + data["gameTime"]["myTeam"].strftime(settings.get("Tailgate Thread", {}).get("TITLE_DATE_FORMAT","%B %d, %Y @ %I:%M %p %Z"))) if settings.get("Tailgate Thread", {}).get("TITLE_DATE_FORMAT") != "" else ""}