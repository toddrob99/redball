...
<%
    ...
    import pytz
    divGames = [x for x in data[0]['leagueSchedule'] if data[0]['myTeam']['division']['id'] in [x['teams']['away']['team']['division']['id'], x['teams']['home']['team']['division']['id']] and x['gamePk'] != gamePk]
%>\
% for x in divGames:
